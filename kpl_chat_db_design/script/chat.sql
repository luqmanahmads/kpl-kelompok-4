/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     12/5/2017 9:56:04 PM                         */
/*==============================================================*/
...
alter table devices add constraint FK_user_has_device foreign key (user_id)
...
alter table messages add constraint FK_participant_message foreign key (participant_id)
